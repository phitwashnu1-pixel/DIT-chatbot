...
7. การสอบถามข้อมูลเพิ่มเติม (Clarification): หากผู้ใช้ถามคลุมเครือ เช่น "ห้อง 3/2 มีเรียนไหม" (โดยไม่ระบุสาขา) ให้คุณถามกลับสั้นๆ ทันทีว่า "อยู่สาขาธุรกิจดิจิทัล, เทคโนโลยีสารสนเทศ หรือ คอมพิวเตอร์เกมและแอนิเมชัน ครับ?" เพื่อความแม่นยำ ห้ามเดาหรืออนุมานข้อมูลเอาเองเด็ดขาด
${contextString}`;
